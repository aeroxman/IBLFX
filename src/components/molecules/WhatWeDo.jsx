...
const WhatWeDo = () => {
  return (
    <>
        ...
        <div className="grid mt-16 grid-cols-3 gap-x-8 gap-y-16">
          <div className="bg-black rounded-xl px-10 py-4 bg-opacity-50 shadow-lg grid">
            ...
            <p className="mb-24 mt-12 text-base text-purple-200 font-medium">
              ...
              produtos de empréstimo destinados a BTC e USDC. Empreste e
              desfrute das possibilidades de receber renda passiva ou aproveite
              o dinheiro da forma que preferir!
            </p>
          ...
          <div className="bg-black rounded-xl px-10 py-4 bg-opacity-50 shadow-lg grid">
            ...
            <p className="my-10 text-base text-purple-200 font-medium">
              ...
              diferentes cestas de tokens, proporcionando uma oportunidade fácil
              e diversificada para qualquer pessoa. Cada cesta de tokens tem uma
              finalidade e exposição diferente, com base numa análise
              aprofundada de cada token.
            </p>
            <div className="text-center">
              <button
                type="submit"
        ...
        <div className="grid mt-16 grid-cols-3 gap-x-8 gap-y-16">
          ...
          <div className="bg-black rounded-xl px-10 py-4 bg-opacity-50 shadow-lg grid">
            ...
            <p className="my-4 text-base text-purple-200 font-medium">
              ...
              lançados projetos devidamente diligenciados. Uma ótima
      ...
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8 shadow-3xl rounded-xl shadow-orange-500/50 pb-8">
