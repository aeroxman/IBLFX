...
const Main = () => {
  return (
    <>
      <div className="pt-10 bg-black lg:pt-20 lg:pb-14 lg:overflow-hidden">
        <div className="mx-auto max-w-7xl lg:px-8">
          <div className="lg:grid lg:grid-cols-2 lg:gap-8">
            <div className="mx-auto max-w-md px-4 lg:px-0 lg:text-left lg:flex lg:items-center">
              <div className="lg:py-24">
                <h1 className="mt-20 text-5xl text-center tracking-tight font-bold text-white lg:mt-6 lg:text-8xl lg:text-left">
                ...
                <p className="text-base text-white text-center px-10 lg:px-0 lg:text-left lg:text-xl">
