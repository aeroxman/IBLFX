              ...
              <div>
                <div className="mt-6">
                  ...
                  <p className="mt-4 text-lg text-cyan-600">
                    Nossa plataforma parceira Greedyfi dá acesso a uma variedade
                    de baskets com diferentes tokens. Uma incrível oportunidade
                    para qualquer um. Cada uma das baskets tem um foco
                    diferente, mas todas são compostas por tokens cuidadosamente
                    selecionados para gerar o máximo de lucro.
                  </p>
                  <div className="mt-4">
                    <button
                      type="submit"
            ...
            <div className="grid mt-16 grid-cols-3 gap-x-8 gap-y-16">
              ...
              <div className="bg-black rounded-xl px-10 py-4 bg-opacity-50 shadow-lg grid">
                ...
                <p className="mb-20 mt-10 text-base text-purple-200 font-medium">
                  ...
                  experiência com operações balcão, além de uma robusta
                  estrutura para otimizar operações no mercado OTC. As operações
                  ocorrem dentro do ambiente seguro IBLFx, sendo a principal
                  alternativa para grandes transações fora dos livros de câmbio.
                </p>
                <div className="text-center">
                  <button
                    type="submit"
              ...
              <div className="bg-black rounded-xl px-10 py-4 bg-opacity-50 shadow-lg grid">
                ...
                <p className="my-10 text-base text-purple-200 font-medium">
                  ...
                  plataforma do <span className="text-cyan-600">Greedyfi</span>{" "}
                  fornece acesso a diferentes cestas de tokens, proporcionando
                  uma oportunidade fácil e diversificada para qualquer pessoa.
                  Cada cesta de tokens tem uma finalidade e exposição diferente,
                  com base numa análise aprofundada de cada token.
                </p>
                <div className="text-center">
                  <button
                    type="submit"
            ...
            <div className="grid mt-16 grid-cols-3 gap-x-8 gap-y-16">
              ...
              <div className="bg-black rounded-xl px-10 py-4 bg-opacity-50 shadow-lg grid">
                ...
                <p className="my-4 text-base text-purple-200 font-medium">
                  ...
                  nativo $IBLFX ainda garante inúmeras vantagens no ecossistema.
                </p>
                <div className="text-center">
                  <button
                    type="submit"
              ...
              <div className="bg-black rounded-xl px-10 py-4 bg-opacity-50 shadow-lg grid">
                ...
                <p className="my-4 text-base text-purple-200 font-medium">
                  ...
                  nível de segurança para a comunidade. Além disso, oferecemos o
                  serviço de Sucessão de Ativos para aqueles que desejam
              ...
              <div>
                <div className="mt-6">
                  ...
                  <p className="mt-8 text-lg text-white">
                    O IBLF<span className="text-realOrange">X</span> Insights é
                    o nosso catálogo de vídeos e e-books totalmente gratuitos
                    para ajudar você a entrar de vez no mundo dos Crypto Ativos,
                    Blockchain e Finanças. Desde materiais educativos até
                    publicações que apresentam impactos nos modelos
                    regulatórios, normativos e contábeis.
                  </p>
      ...
      >
        ...
        <div className="flex justify-center items-center bg-realBlue py-2 w-screen">
          <p className="text-base text-gray-400 ml-60">
            &copy; 2022 |{" "}
            <span className="text-white font-semibold">IBLFX</span> - Todos os
            direitos reservados.
          </p>
          <img
